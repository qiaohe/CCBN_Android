...
public final class NotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (StringPools.ACTION_SHOW_NOTIFICATION.equals(action)) {
            String notificationId = intent
                    .getStringExtra(StringPools.NOTIFICATION_ID);
            String notificationApiKey = intent
                    .getStringExtra(StringPools.NOTIFICATION_API_KEY);
            String notificationTitle = intent
                    .getStringExtra(StringPools.NOTIFICATION_TITLE);
            String notificationMessage = intent
                    .getStringExtra(StringPools.NOTIFICATION_MESSAGE);
            String notificationUri = intent
                    .getStringExtra(StringPools.NOTIFICATION_URI);
